(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode(".ce-hint--align-start{text-align:left}.ce-hint--align-center{text-align:center}.ce-hint__description{opacity:.6;margin-top:3px}.ce-paragraph{line-height:1.6em;outline:none}.ce-block:only-of-type .ce-paragraph[data-placeholder-active]:empty:before,.ce-block:only-of-type .ce-paragraph[data-placeholder-active][data-empty=true]:before{content:attr(data-placeholder-active)}.ce-paragraph p:first-of-type{margin-top:0}.ce-paragraph p:last-of-type{margin-bottom:0}")),document.head.appendChild(e)}}catch(t){console.error("vite-plugin-css-injected-by-js",t)}})();
...
function Ie(n, e, t = "log", o, i = "color: inherit") {
  ...
  o && r.push(o);
  const l = "Editor.js 2.31.0-rc.9999", a = `line-height: 1em;
            color: #006FEA;
...
const S = Ie.bind(window, !1), Y = Ie.bind(window, !0);
function ce(n) {
...
const ci = {
  ...
  static getNamespace(e) {
    return e.split(".").reduce((o, i) => !o || !Object.keys(o).length ? {} : o[i], pe.currentDictionary);
  }
};
...
class R extends Oe {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      let d;
      a || c ? d = !0 : d = !(l.length > 0 && l.every((p) => {
  ...
  set selected(e) {
    var r, l;
    const t = this.holder.parentElement;
    Array.from((t == null ? void 0 : t.children) || []).indexOf(this.holder) === 0 && this.tool.name === "header" && this.settings.holdFirstHeader === !0 && (e = !1), this.holder.classList.toggle(R.CSS.selected, e);
    const i = e === !0 && b.isRangeInsideContainer(this.holder), s = e === !1 && b.isFakeCursorInsideContainer(this.holder);
    (i || s) && ((r = this.editorEventBus) == null || r.emit(zo, { state: e }), i ? b.addFakeCursor() : b.removeFakeCursor(this.holder), (l = this.editorEventBus) == null || l.emit(Uo, { state: e }));
  }
  /**
    ...
    [
      ...
      if (A(r.save))
        try {
          ...
          S(`Tune ${r.constructor.name} save method throws an Error %o`, "warn", l);
        }
    });
  ...
  getTunes() {
    ...
    const s = this.settings.skipTunes || [];
    return i = i.filter((r) => s.indexOf(r.name || "") === -1), i.forEach((r) => {
...
class gi extends E {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, l) => {
      ...
      const c = ((u = l == null ? void 0 : l.conversionConfig) == null ? void 0 : u.export) !== void 0, d = ((p = a.conversionConfig) == null ? void 0 : p.import) !== void 0;
      if (c && d) {
  ...
  get methods() {
    return {
      ...
      getBlockSettings: (e) => this.getBlockSettings(e),
      getBlockSettingsByIndex: (e) => this.getBlockSettingsByIndex(e),
  ...
  getBlockSettings(e) {
    ...
    return this.Editor.BlockManager.getBlockSettings(t);
  }
  getBlockSettingsByIndex(e) {
    const t = this.Editor.BlockManager.getBlockByIndex(e);
    if (!t) {
      Y("There is no block with id `" + id + "`", "warn");
      return;
    }
    return this.Editor.BlockManager.getBlockSettings(t);
  }
...
`);
      ...
      function M(k) {
        ...
        return k.attrs.type === void 0 && (k.attrs.type = "text/css"), Z(m, k.attrs), O(k, m), m;
      }
      function Z(k, m) {
      ...
      function F(k, m) {
        ...
        if (m.singleton) {
          ...
          k.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (w = function(B) {
            ...
            return B.attrs.type === void 0 && (B.attrs.type = "text/css"), B.attrs.rel = "stylesheet", Z(K, B.attrs), O(B, K), K;
          }(m), x = (function(B, K, ve) {
            var se = ve.css, tt = ve.sourceMap, Yn = K.convertToAbsoluteUrls === void 0 && tt;
            (K.convertToAbsoluteUrls || Yn) && (se = g(se)), tt && (se += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(tt)))) + " */");
          ...
          }) : (w = M(m), x = (function(B, K) {
            var ve = K.css, se = K.media;
...
`);
      ...
      var s, r, l, a, c, d, u, p, g;
      t.exports = (s = "cdx-notifies", r = "cdx-notify", l = "cdx-notify__cross", a = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", d = "cdx-notify__input", u = "cdx-notify__button", p = "cdx-notify__btns-wrapper", { alert: g = function(f) {
        var v = document.createElement("DIV"), O = document.createElement("DIV"), T = f.message, M = f.style;
        return v.classList.add(r), M && v.classList.add(r + "--" + M), v.innerHTML = T, O.classList.add(l), O.addEventListener("click", v.remove.bind(v)), v.appendChild(O), v;
      }, confirm: function(f) {
        var v = g(f), O = document.createElement("div"), T = document.createElement("button"), M = document.createElement("button"), Z = v.querySelector("." + l), F = f.cancelHandler, $ = f.okHandler;
        return O.classList.add(p), T.innerHTML = f.okText || "Confirm", M.innerHTML = f.cancelText || "Cancel", T.classList.add(u), M.classList.add(u), T.classList.add(a), M.classList.add(c), F && typeof F == "function" && (M.addEventListener("click", F), Z.addEventListener("click", F)), $ && typeof $ == "function" && T.addEventListener("click", $), T.addEventListener("click", v.remove.bind(v)), M.addEventListener("click", v.remove.bind(v)), O.appendChild(T), O.appendChild(M), v.appendChild(O), v;
      }, prompt: function(f) {
        var v = g(f), O = document.createElement("div"), T = document.createElement("button"), M = document.createElement("input"), Z = v.querySelector("." + l), F = f.cancelHandler, $ = f.okHandler;
        return O.classList.add(p), T.innerHTML = f.okText || "Ok", T.classList.add(u), T.classList.add(a), M.classList.add(d), f.placeholder && M.setAttribute("placeholder", f.placeholder), f.default && (M.value = f.default), f.inputType && (M.type = f.inputType), F && typeof F == "function" && Z.addEventListener("click", F), $ && typeof $ == "function" && T.addEventListener("click", function() {
          $(M.value);
    ...
    t.prototype.clean = function(u) {
      ...
      if (f)
        do {
          ...
          var T = !!p.parentNode, M = i(p) && i(f) && T, Z = f.nodeName.toLowerCase(), F = a(this.config, Z, f), $ = v && O;
          if ($ || c(f, F) || !this.config.keepNestedBlockElements && M) {
...
function qo(n, e) {
  ...
  return Object.entries(n).forEach(([o, i]) => {
    if (D(i)) {
      const s = e ? `${e}.${o}` : o;
      Object.values(i).every((l) => te(l)) ? t[o] = s : t[o] = qo(i, s);
      return;
    }
    t[o] = i;
  }), t;
...
const Zo = class Ee {
  ...
  leafNodesAndReturnIndex(e) {
    if (this.items.length === 0)
      return this.cursor;
    let t = this.cursor;
    return t === -1 ? t = e === Ee.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === Ee.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, h.canSetCaret(this.items[t]) && Fe(() => b.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t;
  }
};
Zo.directions = {
  RIGHT: "right",
  ...
  constructor(e) {
    this.iterator = null, this.activated = !1, this.flipCallbacks = [], this.onKeyDown = (t) => {
      if (!(!this.isEventReadyForHandling(t) || t.shiftKey === !0))
        switch (de.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode) {
          case y.TAB:
    ...
    }, this.iterator = new ke(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || de.usedKeys;
  }
  /**
...
const X = ne("ce-popover-item"), L = {
  container: X(),
  active: X(null, "active"),
  disabled: X(null, "disabled"),
  focused: X(null, "focused"),
  hidden: X(null, "hidden"),
  confirmationState: X(null, "confirmation"),
  noHover: X(null, "no-hover"),
  noFocus: X(null, "no-focus"),
  title: X("title"),
  secondaryTitle: X("secondary-title"),
  icon: X("icon"),
  iconTool: X("icon", "tool"),
  iconChevronRight: X("icon", "chevron-right"),
...
class le extends xt {
  ...
  make(e, t) {
    var s, r;
    const o = (t == null ? void 0 : t.wrapperTag) || "div", i = h.make(o, L.container, {
      type: o === "button" ? "button" : void 0
    });
    return e.name && (i.dataset.itemName = e.name), this.nodes.icon = h.make("div", [L.icon, L.iconTool], {
      innerHTML: e.icon || Qi
    }), i.appendChild(this.nodes.icon), e.title !== void 0 && i.appendChild(h.make("div", L.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && i.appendChild(h.make("div", L.secondaryTitle, {
      textContent: e.secondaryLabel
    })), this.hasChildren && i.appendChild(h.make("div", [L.icon, L.iconChevronRight], {
      innerHTML: qi
...
var j = /* @__PURE__ */ ((n) => (n.Closed = "closed", n.ClosedOnActivate = "closed-on-activate", n.ChildrenOpened = "children-opened", n.ChildrenClosed = "children-closed", n))(j || {});
const z = ne("ce-popover"), P = {
  popover: z(),
...
class as extends Oe {
  ...
  constructor({ items: e, placeholder: t }) {
    super(), this.listeners = new _e(), this.items = e, this.wrapper = h.make("div", rt.wrapper);
...
const en = class tn extends Jo {
  ...
  constructor(e, t) {
    super(e, t), this.nestingLevel = 0, this.nestedPopoverTriggerItem = null, this.previouslyHoveredItem = null, this.scopeElement = document.body, this.hide = () => {
      ...
      this.items.forEach((a) => {
        let c = !1;
        a instanceof le ? c = !o.items.includes(a) : (a instanceof Qo || a instanceof Se) && (c = s || !i), a.toggleHidden(c);
    ...
    }, e.nestingLevel !== void 0 && (this.nestingLevel = e.nestingLevel), this.nestingLevel > 0 && this.nodes.popover.classList.add(P.popoverNested), e.scopeElement !== void 0 && (this.scopeElement = e.scopeElement), this.nodes.popoverContainer !== null && this.listeners.on(this.nodes.popoverContainer, "mouseover", (o) => this.handleHover(o)), e.searchable && this.addSearch(), e.flippable !== !1 && (this.flipper = new de({
  ...
  showNestedPopoverForItem(e) {
    ...
    }), e.onChildrenOpen(), this.emit(j.ChildrenOpened), this.nestedPopover.on(j.ClosedOnActivate, this.hide);
...
class nn extends Jo {
  ...
  constructor(e) {
    ...
    }), this.scrollLocker = new ps(), this.history = new gs(), this.isHidden = !0, this.nodes.overlay = h.make("div", [P.overlay, P.overlayHidden]), this.nodes.popover.insertBefore(this.nodes.overlay, this.nodes.popover.firstChild), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
...
class ms extends E {
   ...
   */
  make() {
    this.nodes.wrapper = h.make("div", [this.CSS.settings]), this.eventsDispatcher.on(Te, this.close);
  }
  /**
   * Destroys module
   */
  ...
  async getTunesItems(e, t, o) {
    ...
    const s = Array.from(this.Editor.Tools.blockTools.values()), r = await Yo(e, s), l = [], a = r.reduce((c, d) => (d.toolbox.forEach((u) => {
      l.indexOf(u.title) === -1 && (c.push({
        icon: u.icon,
        title: U.t(V.toolNames, u.title),
        name: d.name,
        closeOnActivate: !0,
        onActivate: async () => {
          const { BlockManager: p, Caret: g, Toolbar: f } = this.Editor, v = await p.convert(e, d.name, u.data);
          f.close(), g.setToBlock(v, g.positions.END);
        }
      }), l.push(u.title));
    }), c), []);
    return a.length > 0 && (i.push({
      ...
      type: _.Separator
    })), i.push(...t), i.map((c) => this.resolveTuneAliases(c));
  }
  /**
        ...
        return r(a, null, [{ key: "supportedCommands", get: function() {
          ...
          for (var d = 0; d < c.length; d++) {
            ...
            for (var p in a.supportedCommands)
              if (a.supportedCommands[p].includes(c[d])) {
                u = this.commands[p] = !0;
                break;
              }
            u || (this.keys[c[d]] = !0);
...
const Ct = class ln extends Oe {
  ...
  constructor({ api: e, tools: t, i18nLabels: o }) {
    super(), this.opened = !1, this.listeners = new _e(), this.popover = null, this.handleMobileLayoutToggle = () => {
      ...
      toolbox: h.make("div", ln.CSS.toolbox)
  ...
  destroy() {
    var e;
    super.destroy(), this.nodes && this.nodes.toolbox && this.nodes.toolbox.remove(), this.removeAllShortcuts(), (e = this.popover) == null || e.off(j.Closed, this.onPopoverClose), this.listeners.destroy(), this.api.events.off(Te, this.handleMobileLayoutToggle);
  }
  /**
  ...
  open() {
    ...
    this.api.blocks.getBlockSettingsByIndex(e).holdFirstHeader === !0 && e == 0 || this.isEmpty || ((o = this.popover) == null || o.show(), this.opened = !0, this.emit(
      "toolbox-opened"
      /* Opened */
    ));
  }
   ...
   */
  findSingletonBlock(e) {
    var i;
    const t = this.tools.get(e);
    if (((i = t == null ? void 0 : t.settings) == null ? void 0 : i.singleton) !== !0)
      return;
    const o = this.api.blocks.getBlocksCount();
    for (let s = 0; s < o; s++) {
      const r = this.api.blocks.getBlockByIndex(s);
      if ((r == null ? void 0 : r.name) === e)
        return r;
    }
  }
  /**
  ...
  async insertNewBlock(e, t) {
    ...
    if (!i)
      return;
    const s = this.findSingletonBlock(e);
    if (s !== void 0) {
      this.api.caret.setToBlock(s.id, "end"), this.api.toolbar.close();
      return;
    }
...
class Bs extends E {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    if (o)
      ...
      const u = ai(r), p = parseInt(window.getComputedStyle(this.nodes.plusButton).height, 10), g = 8;
      i = t.offsetTop + u - p + g + c;
    }
  ...
  async make() {
    ...
    const e = h.make("div");
    e.appendChild(document.createTextNode(U.ui(V.ui.toolbar.toolbox, "Add"))), e.appendChild(h.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    ...
    const t = h.make("div"), o = h.text(U.ui(V.ui.blockTunes.toggler, "Click to tune")), i = await xs("Slash", "/");
  ...
  enableModuleBindings() {
    ...
    }, !0), be() || this.eventsDispatcher.on(an, (e) => {
      var t;
...
var ae = /* @__PURE__ */ ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(ae || {}), Pe = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(Pe || {}), cn = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(cn || {}), re = /* @__PURE__ */ ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n.BlockConfig = "blockConfig", n))(re || {}), We = /* @__PURE__ */ ((n) => (n.IsInline = "isInline", n.Title = "title", n.IsReadOnlySupported = "isReadOnlySupported", n))(We || {}), mt = /* @__PURE__ */ ((n) => (n.IsTune = "isTune", n))(mt || {});
class Tt {
  /**
   * @class
...
class Cs extends E {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }, this.opened = !1, this.popover = null, this.toolbarVerticalMargin = be() ? 20 : 6, this.tools = /* @__PURE__ */ new Map(), this.isNestedPopoverOpen = !1, this.handleChildrenOpened = () => {
      this.isNestedPopoverOpen = !0;
    }, this.handleChildrenClosed = () => {
      this.isNestedPopoverOpen = !1;
   ...
   */
  async tryToShow(e = !1) {
    this.isNestedPopoverOpen || (e && this.close(), this.allowedToShow() && (await this.open(), this.Editor.Toolbar.close()));
  }
  close() {
    var e, t, o, i;
    if (this.opened) {
      ...
      this.tools = /* @__PURE__ */ new Map(), this.reset(), this.opened = !1, (o = this.popover) == null || o.hide(), (i = this.popover) == null || i.destroy(), this.popover = null;
    }
  }
  /**
  ...
  async open() {
    ...
    }), this.popover.on(j.ChildrenOpened, this.handleChildrenOpened), this.popover.on(j.ChildrenClosed, this.handleChildrenClosed), this.move(this.popover.size.width), (t = this.nodes.wrapper) == null || t.append(this.popover.getElement()), this.popover.show();
  }
  /**
  ...
  async getPopoverItems() {
    ...
    for (const [o, i] of this.tools) {
      ...
      const l = r !== void 0 ? vt(r) : void 0, a = U.t(V.toolNames, o.title || He(o.name));
      [s].flat().forEach((c) => {
        var u, p;
        const d = {
          name: o.name,
...
const Ds = () => typeof window < "u" && window.navigator !== null && Ht(window.navigator.platform) && (/iP(ad|hone|od)/.test(window.navigator.platform) || window.navigator.platform === "MacIntel" && window.navigator.maxTouchPoints > 1);
function Fs(n) {
  const e = mn();
  return n = n.replace(/shift/gi, "⇧").replace(/backspace/gi, "⌫").replace(/enter/gi, "⏎").replace(/up/gi, "↑").replace(/left/gi, "→").replace(/down/gi, "↓").replace(/right/gi, "←").replace(/escape/gi, "⎋").replace(/insert/gi, "Ins").replace(/delete/gi, "␡").replace(/\+/gi, "+"), e.mac ? n = n.replace(/ctrl|cmd/gi, "⌘").replace(/alt/gi, "⌥") : n = n.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN"), n;
}
...
const tr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  throttle: er,
  typeOf: oe
}, Symbol.toStringTag, { value: "Module" })), jt = /* @__PURE__ */ Xn(tr);
...
function jr(n, e, t, o, i) {
  ...
  if (o === "left" ? (r.setStart(n, 0), r.setEnd(e, t)) : (r.setStart(e, t), r.setEnd(n, n.childNodes.length)), i === !0) {
    ...
    return (0, Hr.fragmentToString)(l);
  }
...
class nl extends E {
  ...
  backspace(e) {
    ...
    if (i.isEmpty) {
      if (((d = i.settings) == null ? void 0 : d.holdOnLastBackspace) === !0)
        return;
      t.removeBlock(i);
      const p = t.currentBlock;
      o.setToBlock(p, o.positions.END);
      return;
    }
    if (xo(s, i))
  ...
  delete(e) {
    var c, d;
    const { BlockManager: t, Caret: o } = this.Editor, { currentBlock: i, nextBlock: s } = t, r = ((c = i == null ? void 0 : i.currentInput) == null ? void 0 : c.tagName) === "H1";
    if (((d = i == null ? void 0 : i.settings) == null ? void 0 : d.holdFirstHeader) === !0 && r || !b.isCollapsed || !Re(i.currentInput))
      return;
   ...
   */
  arrowRightAndDown(e) {
    const t = de.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === y.TAB);
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (de.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === y.TAB))
        return;
...
const _o = "block-removed", Mo = "block-added", il = "block-moved", Ao = "block-changed";
class sl {
  constructor() {
    this.completed = Promise.resolve();
  }
...
class rl extends E {
  ...
  insert({
    ...
    var u, p;
    const a = this.Editor.Tools.blockTools.get(t);
    if (((u = a == null ? void 0 : a.settings) == null ? void 0 : u.singleton) === !0) {
      const g = this.blocks.find((f) => f.name === t);
      if (g)
        return g;
    }
    let c = i;
    if (c === void 0 && (c = this.currentBlockIndex + (r ? 0 : 1)), r) {
      const g = this.getBlockByIndex(c);
      ((p = g == null ? void 0 : g.settings) == null ? void 0 : p.holdFirstHeader) === !0 && (g == null ? void 0 : g.holder.previousElementSibling) === null && (r = !1, c = c + 1);
    }
  ...
  paste(e, t, o = !1) {
    ...
    if (((r = i == null ? void 0 : i.settings) == null ? void 0 : r.singleton) === !0) {
      const l = this.blocks.find((a) => a.name === e);
      if (l)
        return l;
    }
    const s = this.insert({
    ...
    try {
      ...
      S(`${e}: onPaste callback call is failed`, "error", l);
    }
    return s;
  }
  /**
  ...
  async mergeBlocks(e, t) {
    ...
    if (e.name === t.name && e.mergeable) {
      ...
      const i = await t.exportDataAsString(), s = G(i, e.tool.sanitizeConfig);
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(il, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
  ...
  async convert(e, t, o) {
    ...
    const r = await e.exportDataAsString(), l = G(
      r,
      s.sanitizeConfig
    );
    let a = Bo(l, s.conversionConfig, s.settings);
...
class ll extends E {
  ...
  clearSelection(e, t = !1) {
    ...
    const r = e && e instanceof KeyboardEvent, l = r && Po(e.keyCode);
    if (this.anyBlockSelected && r && l && !b.isSelectionExists) {
      const a = o.removeSelectedBlocks();
      o.insertDefaultBlockAtIndex(a, !0), i.setToBlock(o.currentBlock), Fe(() => {
        const c = e.key;
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((s) => {
      const r = G(s.holder.innerHTML, this.sanitizerConfig), l = h.make("p");
...
class Ye extends E {
  ...
  navigateNext(e = !1) {
    ...
    if (o === void 0)
      return !1;
    const { nextInput: s, currentInput: r } = o, l = r !== void 0 ? Re(r) : void 0;
    let a = i;
  ...
  navigatePrevious(e = !1) {
    ...
    if (!t)
      return !1;
    const { previousInput: i, currentInput: s } = t, r = s !== void 0 ? Ne(s) : void 0, l = e || r || !t.focusable;
...
const Rn = class Dn extends E {
  constructor() {
    super(...arguments), this.MIME_TYPE = "application/x-editor-js", this.toolsTags = {}, this.tagsByTool = {}, this.blockConfigByTool = {}, this.toolsPatterns = [], this.toolsFiles = {}, this.exceptionList = [], this.processTool = (e) => {
      try {
        const t = e.create({}, {}, !1);
        if (e.pasteConfig === !1) {
        ...
        if (!A(t.onPaste))
          return;
        this.getTagsConfig(e), this.getFilesConfig(e), this.getPatternsConfig(e), this.getBlockConfig(e);
      } catch (t) {
        S(
  ...
  async processDataTransfer(e, t = !1) {
    ...
    const c = Object.keys(this.toolsTags).reduce((p, g) => (p[g.toLowerCase()] = this.toolsTags[g].sanitizationConfig ?? {}, p), {}), d = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }), u = G(a, d);
    !u.trim() || u.trim() === l || !h.isHTMLString(u) ? await this.processText(l) : await this.processText(u, !0);
  }
  /**
   ...
   */
  getBlockConfig(e) {
    e.blockConfig !== !1 && (this.blockConfigByTool[e.name] = e.blockConfig || {});
  }
  getBlockConfigByToolValue(e, t, o) {
    return o === void 0 && (o = !1), (this.blockConfigByTool[e] || {})[t] || o;
  }
  /**
   * Get tags to substitute by Tool
   *
   ...
   */
  async processFile(e) {
    const t = Jn(e), o = Object.entries(this.toolsFiles).find(([r, { mimeTypes: l, extensions: a }]) => {
      const [c, d] = e.type.split("/"), u = a.find((g) => g.toLowerCase() === t.toLowerCase()), p = l.find((g) => {
        const [f, v] = g.split("/");
        return f === c && (v === d || v === "*");
      });
      return !!u || !!p;
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      ...
      const { tags: c } = l.pasteConfig || { tags: [] }, d = c.reduce((g, f) => (this.collectTagNames(f).forEach((O) => {
        const T = D(f) ? f[O] : null;
        g[O.toLowerCase()] = T || {};
      }), g), {}), u = Object.assign({}, d, l.baseSanitizeConfig);
      if (!this.getBlockConfigByToolValue(l.name, "skipSanitizer", !1))
        if (r.tagName.toLowerCase() === "table") {
          const g = G(r.outerHTML, u);
          r = h.make("div", void 0, {
            innerHTML: g
          }).firstChild;
        } else
          r.innerHTML = G(r.innerHTML, u);
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags), s = e, { tool: r } = this.toolsTags[s.tagName] || {}, l = (r == null ? void 0 : r.name) || "", a = this.tagsByTool[l] || [], c = i.includes(s.tagName), d = h.blockElements.includes(s.tagName.toLowerCase()), u = Array.from(s.children).some(
      ({ tagName: f }) => i.includes(f) && !a.includes(f)
    ), p = this.getBlockConfigByToolValue(l, "ignoreContainsAnotherToolTags", !1), g = Array.from(s.children).some(
...
class Be extends E {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = h.make("div", Be.CSS.overlay, {}), i = h.make("div", Be.CSS.overlayContainer, {}), s = h.make("div", Be.CSS.rect, {});
  ...
  trySelectNextBlock(e) {
    ...
    let a = r;
    o > 1 && (a = l ? i : s);
    const c = e > this.stackOfSelected[o - 1] && a === i, d = e < this.stackOfSelected[o - 1] && a === s, p = !(c || d || a === r);
    ...
    return new Promise((t) => {
      ...
      if (e.length === 0)
        ...
        const s = e.map(({ type: r, data: l, tunes: a, id: c }) => {
          o.available.has(r) === !1 && (Y(`Tool «${r}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), l = this.composeStubDataForTool(r, l, c), r = o.stubTool);
          let d;
          try {
            d = i.composeBlock({
              id: c,
...
class Fn {
  ...
  async render() {
    ...
    if (i.length === 0)
      return [];
    const s = [], r = i.reduce((d, u) => {
      var p;
      return (p = u.toolbox) == null || p.forEach((g) => {
        s.indexOf(g.title) === -1 && (d.push({
          icon: g.icon,
          title: U.t(V.toolNames, g.title || ""),
          name: u.name,
          closeOnActivate: !0,
          onActivate: async () => {
            const f = await this.blocksAPI.convert(t.id, u.name, g.data);
            this.caretAPI.setToBlock(f, "end");
          }
        }), s.push(g.title));
      }), d;
    }, []), l = await t.getActiveToolboxEntry(), a = l !== void 0 ? l.icon : Go, c = !be();
    return {
      icon: a,
      name: "convert-to",
      hint: {
...
class Hn {
   ...
   */
  make() {
    const e = h.make("div", this.CSS.wrapper), t = is, o = h.make("div", this.CSS.info), i = h.make("div", this.CSS.title, {
...
var wl = Object.defineProperty, El = Object.getOwnPropertyDescriptor, jn = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? El(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && wl(e, t, i), i;
};
class vo extends Tt {
  constructor() {
   ...
   */
  get toolbox() {
    const e = this.constructable[re.Toolbox], t = this.config[Pe.Toolbox];
    if (!q(e) && t !== !1)
   ...
   */
  get blockConfig() {
    return this.constructable[re.BlockConfig] ?? {};
  }
  get sanitizeConfig() {
...
class $n {
   ...
   */
  render() {
    const e = this.api.blocks.getCurrentBlockIndex(), t = this.api.blocks.getBlockSettingsByIndex(e);
    return e === 0 && t && t.holdFirstHeader === !0 ? [] : {
      icon: Xi,
   ...
   */
  handleClick() {
    const e = this.api.blocks.getCurrentBlockIndex(), t = this.api.blocks.getBlockSettingsByIndex(e), o = e + 1, i = this.api.blocks.getBlockByIndex(o);
    if (e === 0 && t && t.holdFirstHeader === !0)
      throw new Error("holdFirstHeader === true");
    if (!i)
      throw new Error("Unable to move Block down since it is already the last");
    const s = i.holder, r = s.getBoundingClientRect();
    let l = Math.abs(window.innerHeight - s.offsetHeight);
    r.top < window.innerHeight && (l = window.scrollY + s.offsetHeight), window.scrollTo(0, l), this.api.blocks.move(o), this.api.toolbar.toggleBlockSettings(!0);
  }
}
$n.isTune = !0;
class zn {
...
class Un {
   ...
   */
  handleClick() {
    const e = this.api.blocks.getCurrentBlockIndex(), t = this.api.blocks.getBlockByIndex(e), o = e - 1, i = this.api.blocks.getBlockByIndex(o), s = this.api.blocks.getBlockSettingsByIndex(o);
    if (o === 0 && s && s.holdFirstHeader === !0)
      throw new Error("holdFirstHeader === true");
    if (e === 0 || !t || !i)
      throw new Error("Unable to move Block up since it is already the first");
    const r = t.holder, l = i.holder, a = r.getBoundingClientRect(), c = l.getBoundingClientRect();
    let d;
    c.top > 0 ? d = Math.abs(a.top) - Math.abs(c.top) : d = Math.abs(a.top) + c.height, window.scrollBy(0, -1 * d), this.api.blocks.move(o), this.api.toolbar.toggleBlockSettings(!0);
  }
}
Un.isTune = !0;
var Bl = Object.defineProperty, Cl = Object.getOwnPropertyDescriptor, Tl = (n, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Cl(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && Bl(e, t, i), i;
};
class Wn extends E {
  constructor() {
...
class Il extends E {
  constructor() {
    ...
    }, dl), this.documentTouchedListener = (e) => {
  ...
  get someFlipperButtonFocused() {
    return this.Editor.Toolbar.toolbox.hasFocus() ? !0 : Object.entries(this.Editor).filter(([e, t]) => t.flipper instanceof de).some(([e, t]) => t.flipper.hasFocus());
  }
  /**
   * Clean editor`s UI
   */
  ...
  loadStyles() {
    ...
    this.config.style && !q(this.config.style) && this.config.style.nonce && t.setAttribute("nonce", this.config.style.nonce), h.prepend(document.head, t);
  }
  /**
  ...
  watchBlockHoveredEvents() {
    ...
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", dt((t) => {
      ...
      this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(an, {
...
class _l {
  ...
  set configuration(e) {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (q(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && U.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
