          ...
          return this.map(function(r) {
            var l = function(a, c) {
              ...
              if (c && typeof btoa == "function") {
                var f = (p = u, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(p)))) + " */"), g = u.sources.map(function(v) {
...
`);
      ...
      t.exports = (s = "cdx-notifies", r = "cdx-notify", l = "cdx-notify__cross", a = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", d = "cdx-notify__input", u = "cdx-notify__button", f = "cdx-notify__btns-wrapper", { alert: g = function(p) {
        ...
        var v = g(p), O = document.createElement("div"), T = document.createElement("button"), M = document.createElement("button"), Z = v.querySelector("." + l), F = p.cancelHandler, $ = p.okHandler;
        return O.classList.add(f), T.innerHTML = p.okText || "Confirm", M.innerHTML = p.cancelText || "Cancel", T.classList.add(u), M.classList.add(u), T.classList.add(a), M.classList.add(c), F && typeof F == "function" && (M.addEventListener("click", F), Z.addEventListener("click", F)), $ && typeof $ == "function" && T.addEventListener("click", $), T.addEventListener("click", v.remove.bind(v)), M.addEventListener("click", v.remove.bind(v)), O.appendChild(T), O.appendChild(M), v.appendChild(O), v;
      }, prompt: function(p) {
        var v = g(p), O = document.createElement("div"), T = document.createElement("button"), M = document.createElement("input"), Z = v.querySelector("." + l), F = p.cancelHandler, $ = p.okHandler;
        return O.classList.add(f), T.innerHTML = p.okText || "Ok", T.classList.add(u), T.classList.add(a), M.classList.add(d), p.placeholder && M.setAttribute("placeholder", p.placeholder), p.default && (M.value = p.default), p.inputType && (M.type = p.inputType), F && typeof F == "function" && Z.addEventListener("click", F), $ && typeof $ == "function" && T.addEventListener("click", function() {
          $(M.value);
...
(function(n, e) {
  (function(t, o) {
    ...
    function t(u) {
      var f = u.tags, g = Object.keys(f), p = g.map(function(v) {
        return typeof f[v];
      }).every(function(v) {
    ...
    t.prototype.clean = function(u) {
      ...
      if (p)
        do {
          ...
          var T = !!f.parentNode, M = i(f) && i(p) && T, Z = p.nodeName.toLowerCase(), F = a(this.config, Z, p), $ = v && O;
          if ($ || c(p, F) || !this.config.keepNestedBlockElements && M) {
    ...
    function d(u, f, g) {
      ...
      return f === !0 ? !1 : typeof f[p] == "function" ? !f[p](u.value, g) : typeof f[p] > "u" || f[p] === !1 ? !0 : typeof f[p] == "string" ? f[p] !== u.value : !1;
    }
    return t;
  });
})(Xo);
  ...
  async getTunesItems(e, t, o) {
    ...
    const s = Array.from(this.Editor.Tools.blockTools.values()), r = await Yo(e, s), l = [], a = r.reduce((c, d) => (d.toolbox.forEach((u) => {
      l.indexOf(u.title) === -1 && (c.push({
        ...
        closeOnActivate: !0,
        onActivate: async () => {
          const { BlockManager: f, Caret: g, Toolbar: p } = this.Editor, v = await f.convert(e, d.name, u.data);
          p.close(), g.setToBlock(v, g.positions.END);
        }
      }), l.push(u.title));
    }), c), []);
...
class Bs extends E {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    if (o)
      ...
      const u = ai(r), f = parseInt(window.getComputedStyle(this.nodes.plusButton).height, 10), g = 8;
      i = t.offsetTop + u - f + g + c;
    }
...
function Yr(n, e) {
  ...
  if (e === void 0 && (e = !0), (0, Wr.isNativeInput)(n)) {
    ...
    var l = function(f) {
      ...
      f.appendChild(g), s.setStart(g, 0), s.setEnd(g, 0);
    }, a = function(f) {
      return f != null;
...
class rl extends E {
  ...
  insert({
    ...
    if (((u = a == null ? void 0 : a.settings) == null ? void 0 : u.singleton) === !0) {
      const g = this.blocks.find((p) => p.name === t);
      if (g)
        return g;
    }
    let c = i;
    if (c === void 0 && (c = this.currentBlockIndex + (r ? 0 : 1)), r) {
      ...
      ((f = g == null ? void 0 : g.settings) == null ? void 0 : f.holdFirstHeader) === !0 && (g == null ? void 0 : g.holder.previousElementSibling) === null && (r = !1, c = c + 1);
    }
...
const Rn = class Dn extends E {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    const c = Object.keys(this.toolsTags).reduce((f, g) => (f[g.toLowerCase()] = this.toolsTags[g].sanitizationConfig ?? {}, f), {}), d = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }), u = G(a, d);
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      ...
      const { tags: c } = l.pasteConfig || { tags: [] }, d = c.reduce((g, p) => (this.collectTagNames(p).forEach((O) => {
  ...
  processElementNode(e, t, o) {
    ...
    ), f = this.getBlockConfigByToolValue(l, "ignoreContainsAnotherToolTags", !1), g = Array.from(s.children).some(
...
class Fn {
  ...
  async render() {
    ...
    const s = [], r = i.reduce((d, u) => {
      var f;
      return (f = u.toolbox) == null || f.forEach((g) => {
        s.indexOf(g.title) === -1 && (d.push({
          ...
          closeOnActivate: !0,
          onActivate: async () => {
            const p = await this.blocksAPI.convert(t.id, u.name, g.data);
