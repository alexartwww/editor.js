...
function Ie(n, e, t = "log", o, i = "color: inherit") {
  ...
  o && r.push(o);
  const a = "Editor.js 2.31.0-rc.9999", l = `line-height: 1em;
            color: #006FEA;
...
class R extends Oe {
  ...
  set selected(e) {
    ...
    (i || s) && ((r = this.editorEventBus) == null || r.emit(zo, { state: e }), i ? b.addFakeCursor() : b.removeFakeCursor(this.holder), (a = this.editorEventBus) == null || a.emit(Uo, { state: e }));
  }
  /**
...
class gi extends E {
  constructor() {
    super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, s, r, a) => {
      ...
      const c = ((u = a == null ? void 0 : a.conversionConfig) == null ? void 0 : u.export) !== void 0, d = ((f = l.conversionConfig) == null ? void 0 : f.import) !== void 0;
      if (c && d) {
...
`);
      ...
      var s, r, a, l, c, d, u, f, g;
      t.exports = (s = "cdx-notifies", r = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", d = "cdx-notify__input", u = "cdx-notify__button", f = "cdx-notify__btns-wrapper", { alert: g = function(p) {
        ...
        var v = g(p), O = document.createElement("div"), T = document.createElement("button"), M = document.createElement("button"), Z = v.querySelector("." + a), F = p.cancelHandler, $ = p.okHandler;
        return O.classList.add(f), T.innerHTML = p.okText || "Confirm", M.innerHTML = p.cancelText || "Cancel", T.classList.add(u), M.classList.add(u), T.classList.add(l), M.classList.add(c), F && typeof F == "function" && (M.addEventListener("click", F), Z.addEventListener("click", F)), $ && typeof $ == "function" && T.addEventListener("click", $), T.addEventListener("click", v.remove.bind(v)), M.addEventListener("click", v.remove.bind(v)), O.appendChild(T), O.appendChild(M), v.appendChild(O), v;
      }, prompt: function(p) {
        var v = g(p), O = document.createElement("div"), T = document.createElement("button"), M = document.createElement("input"), Z = v.querySelector("." + a), F = p.cancelHandler, $ = p.okHandler;
        return O.classList.add(f), T.innerHTML = p.okText || "Ok", T.classList.add(u), T.classList.add(l), M.classList.add(d), p.placeholder && M.setAttribute("placeholder", p.placeholder), p.default && (M.value = p.default), p.inputType && (M.type = p.inputType), F && typeof F == "function" && Z.addEventListener("click", F), $ && typeof $ == "function" && T.addEventListener("click", function() {
          $(M.value);
    ...
    t.prototype.clean = function(u) {
      ...
      if (p)
        do {
          ...
          var T = !!f.parentNode, M = i(f) && i(p) && T, Z = p.nodeName.toLowerCase(), F = l(this.config, Z, p), $ = v && O;
...
class Jo extends Oe {
   ...
   */
  get itemsDefault() {
    return this.items.filter((e) => e instanceof ae);
  }
  /**
  ...
  buildItems(e) {
    return e.map((t) => {
      switch (t.type) {
        ...
        default:
          return new ae(t, this.itemsRenderParams[_.Default]);
      }
    });
  }
  /**
   ...
   */
  getTargetItem(e) {
    return this.items.filter((t) => t instanceof ae || t instanceof Se).find((t) => {
  ...
  toggleItemActivenessIfNeeded(e) {
    if (e instanceof ae && (e.toggle === !0 && e.toggleActive(), typeof e.toggle == "string")) {
  ...
  constructor(e, t) {
    super(e, t), this.nestingLevel = 0, this.nestedPopoverTriggerItem = null, this.previouslyHoveredItem = null, this.scopeElement = document.body, this.hide = () => {
      ...
      this.items.forEach((l) => {
        let c = !1;
        l instanceof ae ? c = !o.items.includes(l) : (l instanceof Qo || l instanceof Se) && (c = s || !i), l.toggleHidden(c);
...
class hs extends Bt {
  ...
  constructor(e) {
    ...
    super(
      ...
      !(o instanceof ae) && !(o instanceof Se) || o.hasChildren && o.isChildrenOpen && this.showNestedItems(o);
    });
  }
  /**
   * Returns visible element offset top
...
class ms extends E {
  ...
  async getTunesItems(e, t, o) {
    ...
    const s = Array.from(this.Editor.Tools.blockTools.values()), r = await Yo(e, s), a = [], l = r.reduce((c, d) => (d.toolbox.forEach((u) => {
      a.indexOf(u.title) === -1 && (c.push({
        icon: u.icon,
...
class Bs extends E {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    if (o)
      ...
      const u = li(r), f = parseInt(window.getComputedStyle(this.nodes.plusButton).height, 10), g = 8;
...
var le = /* @__PURE__ */ ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(le || {}), Pe = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(Pe || {}), cn = /* @__PURE__ */ ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(cn || {}), re = /* @__PURE__ */ ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n.BlockConfig = "blockConfig", n))(re || {}), We = /* @__PURE__ */ ((n) => (n.IsInline = "isInline", n.Title = "title", n.IsReadOnlySupported = "isReadOnlySupported", n))(We || {}), mt = /* @__PURE__ */ ((n) => (n.IsTune = "isTune", n))(mt || {});
class Tt {
  /**
   * @class
...
class Cs extends E {
  ...
  close() {
    ...
    if (this.opened) {
      ...
      for (const [s, r] of this.tools) {
        const a = this.getToolShortcut(s.name);
        a !== void 0 && ge.remove(this.Editor.UI.nodes.redactor, a), A(r.clear) && r.clear();
      }
  ...
  async getPopoverItems() {
    ...
    for (const [o, i] of this.tools) {
      ...
      const a = r !== void 0 ? vt(r) : void 0, l = U.t(V.toolNames, o.title || He(o.name));
      [s].flat().forEach((c) => {
        var u, f;
        const d = {
          name: o.name,
...
function jr(n, e, t, o, i) {
  ...
  if (o === "left" ? (r.setStart(n, 0), r.setEnd(e, t)) : (r.setStart(e, t), r.setEnd(n, n.childNodes.length)), i === !0) {
    ...
    return (0, Hr.fragmentToString)(a);
  }
...
class na extends E {
  ...
  backspace(e) {
    ...
    if (((l = s == null ? void 0 : s.settings) == null ? void 0 : l.holdFirstHeader) === !0 || i === void 0 || !b.isCollapsed || !i.currentInput || !Ne(i.currentInput))
      return;
...
class ra extends E {
  ...
  insert({
    ...
    if (((u = l == null ? void 0 : l.settings) == null ? void 0 : u.singleton) === !0) {
...
class aa extends E {
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((s) => {
      const r = G(s.holder.innerHTML, this.sanitizerConfig), a = h.make("p");
...
const Rn = class Dn extends E {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    const c = Object.keys(this.toolsTags).reduce((f, g) => (f[g.toLowerCase()] = this.toolsTags[g].sanitizationConfig ?? {}, f), {}), d = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }), u = G(l, d);
  ...
  async processFile(e) {
    const t = Jn(e), o = Object.entries(this.toolsFiles).find(([r, { mimeTypes: a, extensions: l }]) => {
      const [c, d] = e.type.split("/"), u = l.find((g) => g.toLowerCase() === t.toLowerCase()), f = a.find((g) => {
        const [p, v] = g.split("/");
        return p === c && (v === d || v === "*");
      });
      return !!u || !!f;
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags), s = e, { tool: r } = this.toolsTags[s.tagName] || {}, a = (r == null ? void 0 : r.name) || "", l = this.tagsByTool[a] || [], c = i.includes(s.tagName), d = h.blockElements.includes(s.tagName.toLowerCase()), u = Array.from(s.children).some(
...
class Fn {
  ...
  async render() {
    ...
    }, []), a = await t.getActiveToolboxEntry(), l = a !== void 0 ? a.icon : Go, c = !be();
    return {
      icon: l,
      name: "convert-to",
      hint: {
...
var wa = Object.defineProperty, Ea = Object.getOwnPropertyDescriptor, jn = (n, e, t, o) => {
...
class $n {
  ...
  handleClick() {
    ...
    let a = Math.abs(window.innerHeight - s.offsetHeight);
    r.top < window.innerHeight && (a = window.scrollY + s.offsetHeight), window.scrollTo(0, a), this.api.blocks.move(o), this.api.toolbar.toggleBlockSettings(!0);
  }
}
$n.isTune = !0;
class zn {
...
class Un {
  ...
  handleClick() {
    ...
    const r = t.holder, a = i.holder, l = r.getBoundingClientRect(), c = a.getBoundingClientRect();
    let d;
    c.top > 0 ? d = Math.abs(l.top) - Math.abs(c.top) : d = Math.abs(l.top) + c.height, window.scrollBy(0, -1 * d), this.api.blocks.move(o), this.api.toolbar.toggleBlockSettings(!0);
  }
}
Un.isTune = !0;
