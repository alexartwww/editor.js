import type { API, BlockAPI, PasteConfig, ToolboxConfig } from '@/types';
import type {
  BlockToolConstructorOptions,
  MenuConfigItem,
  ToolConfig
} from '@/types/tools';
import { IconChecklist, IconListBulleted, IconListNumbered } from '../icons';
import { IconStartWith } from './styles/icons';
...
import { OlCounterIconsMap, OlCounterTypesMap, type OlCounterType } from './types/OlCounterType';
