...
import {IconAlignCenter, IconAlignLeft, IconQuote} from '../icons';
import {make} from '@editorjs/dom';
import type {API, BlockAPI, BlockTool, ConversionConfig, SanitizerConfig, ToolConfig} from '@/types';
import type {MenuConfig} from '@/types/tools';
import {HTMLPasteEvent, PasteConfig} from '@/types';
